...
- `PROOF_29_PHONE_bomblevel_3stars_72290.png` — **ON THE PHONE — a THIRD win, in a harder level, and the star counter proves it was earned here.** `Tutorial_bomb_niko`: 4 pigs across 3 stone towers with a central A-frame, played with Bomb birds. `LEVEL CLEARED!` **3 stars, 72290** — and the episode star total reads **12**, against **9** in PROOF_28 taken minutes earlier. That before/after settles what R54 could only caveat: **3 stars were unambiguously earned in this session, on the device.** Same process throughout (pid 11197, age 1:26). R55.
- `PROOF_31_PHONE_levelfailed.png` — **ON THE PHONE — the LOSS path, which is a different code path from the win.** `LEVEL FAILED!` after `Tutorial_blues_niko` was attempted and lost (the fixed drag vector cannot aim at arbitrary geometry). The fail screen renders correctly, the star counter correctly stays at **12**, and `h_fatal` is **0** — so both level-end transitions, win and loss, survive on real hardware. R55.
- `PROOF_30_PHONE_bomb_explosion_21810.png` — **ON THE PHONE — physics, collision, destruction and scoring, mid-flight.** The first bomb detonating in `Tutorial_bomb_niko`: left tower reduced to rubble, the central A-frame collapsing with blocks still in mid-air, one pig visibly killed, **SCORE 21810** (from 0). This is the engine's rigid-body simulation running under the ARM32→ARM64 shim on real silicon. R55.
...
53002cabef506a44c01e390a2d17b4e5e3c9962eac4bc05d6a055086cdc54394  PROOF_29_PHONE_bomblevel_3stars_72290.png
b21861c711e67a5dbf16fd36298e0b12e61c7ce76e86904bdcc3f1878dd91f4e  PROOF_30_PHONE_bomb_explosion_21810.png
c972ad19f80e618fb57b11675c298f90f8c36bfdb4c3dc8833fbb3fb308768ad  PROOF_31_PHONE_levelfailed.png
