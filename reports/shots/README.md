...
| `PROOF_21_a56_geometry.png` | **WINS at the Galaxy A56's actual screen geometry** — 1080x2340 panel, so a 2340x1080 landscape capture. "LEVEL CLEARED", 3 stars, **39830**, `h_fatal=0`, frame[2401]. Full-bleed, **no letterboxing** (`resizeableActivity="false"` is declared, but targetSdk 26 lifts the 1.86 max-aspect cap). The win also proves **touch coordinates map correctly through the shim at this resolution** — nothing else had exercised that above 640x320. Largest texture upload unchanged at 2000x1991 despite a 3.7x larger framebuffer | x86shim-shaders | 34 | `emu_a56_screen.sh` |
