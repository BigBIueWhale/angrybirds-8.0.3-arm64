...
| `PROOF_2_interactive_level.png` | Tutorial level up and interactive: slingshot loaded, pigs placed, score 0, drag hint | x86shim `7f99c553` | 25 | `emu_interactive_capture.sh` |
| `PROOF_3_bird_launched.png` | Bird launched and connected — impact burst, score popups, debris, a live scored hit | x86shim `7f99c553` | 25 | `emu_interactive_capture.sh` |
| `PROOF_4_debris_settle.png` | The shot has resolved: structure collapsed, score well above zero, physics still settling. Exact framing varies per run (see the note below) | x86shim `7f99c553` | 25 | `emu_interactive_capture.sh` |
