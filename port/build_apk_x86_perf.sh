#!/bin/bash
# build_apk_x86_perf.sh — a MEASUREMENT-ONLY variant: release configuration plus the perf timers.
#
# WHY THIS EXISTS
# ---------------
...
#
# Output: out/angrybirds-8.0.3-x86shim-perf.apk - NOT a deliverable, and not signed for release.
...
$CC -shared -fPIC -O2 -DABSHIM_RELEASE -DABSHIM_PERF -Wno-unused -I/opt/unicorn/include -I"$S" $SRCS \
...
X86R_APK="angrybirds-8.0.3-x86shim-perf.apk"
