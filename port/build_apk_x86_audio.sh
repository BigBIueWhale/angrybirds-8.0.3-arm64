...
$CC -shared -fPIC -O2 -DABSHIM_RELEASE -DABSHIM_AUDIO -Wno-unused -I/opt/unicorn/include -I"$S" $SRCS \
...
apksigner sign --ks "$KS" --ks-pass pass:android --key-pass pass:android \
  --out "$OUTDIR/angrybirds-8.0.3-x86shim-audio.apk" /tmp/al_x86.apk
echo "DONE -> $OUTDIR/angrybirds-8.0.3-x86shim-audio.apk"
unzip -l "$OUTDIR/angrybirds-8.0.3-x86shim-audio.apk" | grep -E 'lib/x86_64|classes.dex'
